...
// Graceful imports — fallback if not available
let PHI_TIMING = { CYCLE: 60000 };
try { const mod = await import('../shared/phi-math.js'); PHI_TIMING = mod.PHI_TIMING || PHI_TIMING; } catch (_) {}
let logger = { info: console.log, error: console.error };
try { const mod = await import('./utils/logger.js'); logger = mod.default || mod; } catch (_) {}
...
export { AutoCommitDeploy, autoCommitDeploy };
export default autoCommitDeploy;
