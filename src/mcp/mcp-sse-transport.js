...
const PHI_TIMING = { CYCLE: Math.round(1.618033988749895 * 1.618033988749895 * 10000) }; // ~26.2s
const crypto = require('crypto');
// Use native fetch (Node 18+) — no custom wrapper needed
const logger = {
  logNodeActivity: (source, msg) => console.log(`[${source}] ${msg}`),
};
...
class McpSseTransport {
    constructor(opts = {}) {
        ...
        this.baseUrl = opts.baseUrl || process.env.HEADY_MANAGER_URL || 'http://localhost:3300';
