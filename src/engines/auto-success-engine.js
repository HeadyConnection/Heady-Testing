...
const PERFORMANCE = {
  ...
  async garbageCollectionFrequency() {
    ...
    const fragRatio = heapStats.heap_size_limit > 0
      ...
      : 0;
    const status = fragRatio < PSI ? 'pass' : fragRatio < (1 - PSI * PSI) ? 'warn' : 'fail';
...
/**
 * φ-scaled task registry per LAW-07 v4.0.0.
 * Current: 9 categories, 135 tasks — scaling toward fib(7)=13 categories, fib(12)=144 tasks.
