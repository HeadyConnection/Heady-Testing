...
// Graceful logger import — fallback to console if logger not available
let logger = { logSystem: console.log, error: console.error, info: console.log };
try { const mod = await import("../utils/logger.js"); logger = mod.default || mod; } catch (_) { /* use console fallback */ }
...
export { AutoCommitEngine, autoCommitEngine };
export default autoCommitEngine;
